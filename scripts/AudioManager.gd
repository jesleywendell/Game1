...
const SFX_PATHS := {
	...
	"coxinha_attack1": "res://assets/audio/enemies/knight_coxinha/ataquecoxinha1.mp3",
	"coxinha_attack2": "res://assets/audio/enemies/knight_coxinha/ataquecoxinha2.mp3",
	"coxinha_die":     "res://assets/audio/enemies/knight_coxinha/barulho_derrota.mp3",
	"coxinha_windup":  "res://assets/audio/enemies/knight_coxinha/somcoxinha.mp3",
}
